            ...
            <Route path="/" element={<Layout />}>
              ...
              <Route path="/employees">
                <Route
                  path=""
                  element={
                    (isAuthenticated(["Admin", "Supervisor", "Accountant"]) && (
                      <Employee />
                    )) ||
                    (isAuthenticated([
                      "Admin",
              ...
              <Route
                path="/employeetypes"
                element={
                  (isAuthenticated(["Admin"]) && <EmployeeTypes />) || (
                    <Navigate to="/" />
                  )
                }
              />
              <Route
                path="/shifts"
                element={
                  (isAuthenticated(["Admin", "Supervisor"]) && <Shifts />) || (
                    <Navigate to="/" />
                  )
                }
              />
              ...
              <Route
                path="/roster"
                element={
                  (isAuthenticated(["Admin", "ShiftLead", "Supervisor"]) && (
                    <Roster />
                  )) ||
                  (isAuthenticated([
                    "Admin",
              ...
              <Route
                path="/forecast"
                element={
                  isAuthenticated(["Admin", "Accountant"]) && <Forecast />
                }
              />
              <Route path="/vacationrequests">
                <Route
                  path=""
                  element={
                    (isAuthenticated(["Admin", "Supervisor"]) && (
                      <VacationRequest />
                ...
                <Route
                  ...
                  element={
                    (isAuthenticated([
                      ...
                      "ShiftLead",
                      "Supervisor",
                    ]) && <VacationRequestPerEmployee />) || <Navigate to="/" />
                  }
                />
                <Route
                  path="create"
